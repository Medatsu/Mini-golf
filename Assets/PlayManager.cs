...
public class PlayManager : MonoBehaviour
{
    ...
    private void onEnable(){
         ballController.onBallShooted.AddListener(UpdateShoootCount);
    }

    private void onDisable(){
         ballController.onBallShooted.RemoveListener(UpdateShoootCount);
    }
   ...
   public void UpdateShoootCount(int shootCount)
   {
